...
for class_index, class_name in enumerate(gt_classes):
  ...
  with open(tmp_files_path + "/" + class_name.replace("/", "_") + "_predictions.json", 'w') as outfile:
    json.dump(bounding_boxes, outfile)
...
with open(results_files_path + "/{}_{}_results.txt".format(args.dataset,args.modelName), 'w') as results_file:
  ...
  for class_index, class_name in enumerate(gt_classes):
    ...
    """
    predictions_file = tmp_files_path + "/" + class_name.replace("/", "_") + "_predictions.json"
